    ...
    <div className="order-1 lg:order-2 lg:col-span-5 relative mb-16 lg:mb-0 min-h-[500px]">
      ...
      >
        ...
        >
          ...
          {/* Card Header */}
          <div
            className="absolute top-0 left-0 w-full h-12 border-b border-cyber-dim flex justify-between items-center px-4 bg-cyber-gray/30"
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-display font-bold tracking-widest text-cyber-cyan">
                NETRUNNER_ID
              </span>
            </div>
          ...
          {/* Sidebar Metadata */}
          <div
            className="absolute top-32 left-4 flex flex-col gap-4 text-[8px] font-mono text-cyber-cyan/50"
              ...
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className={`w-1 h-3 ${
                      i <= 4 ? "bg-cyber-cyan" : "bg-cyber-cyan/20"
                    }`}
                  ></div>
                ))}
              </div>
          ...
          <div
            className="absolute top-32 right-4 flex flex-col gap-4 text-[8px] font-mono text-cyber-pink/50 items-end"
            style={{ transform: "translateZ(15px)" }}
          >
          ...
          {/* Details Section */}
          <div
            className="absolute top-[260px] lg:top-60 left-0 w-full px-6 lg:px-6 space-y-4"
          ...
          >
            <div className="text-center relative">
              ...
              <h3 className="text-2xl lg:text-xl font-display font-bold text-white tracking-widest leading-none mb-1">
                EZZELDDIN ABDALLAH
              </h3>
              <p className="text-xs lg:text-[10px] font-mono text-cyber-pink tracking-[0.2em] uppercase font-bold">
                FRONT-END ENGINEER
              </p>
            </div>
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="group/stat">
                <div className="flex justify-between items-center text-[11px] font-mono text-white/90 mb-1 flex-wrap">
                  <div className="flex items-center gap-2">
                    <span className="bg-black rounded-full flex items-center justify-center">
                      <SiNextdotjs size={14} />
                    </span>
                    <span>NEXT.JS</span>
                  </div>
              ...
              <div className="group/stat">
                <div className="flex justify-between items-center text-[11px] font-mono text-cyber-yellow mb-1">
                  <div className="flex items-center gap-2 text-[#3178C6]">
                    <span className="bg-white rounded-[2px] flex items-center justify-center">
